...
namespace LagoVista.IoT.DeviceManagement.Repos.Repos
{
    ...
    {
        public DeviceArchiveRepo(IDeviceManagementSettings settings, ILogger logger) : base(settings.DeviceManagementArchiveTableStorage.AccountId,  settings.DeviceManagementArchiveTableStorage.AccessKey, logger)
        {
