...
// ContentHash: 6f4aa08062d671a679fc114694b3798645f26503adcc3b920b8d56c453accfba
// IndexVersion: 2
// --- END CODE INDEX META ---
...
namespace LagoVista.IoT.DeviceManagement.Core.Repos
{
    public interface IDeviceManagementRepo
    {
        ...
        Task<ListResponse<DeviceSummary>> GetDevicesWithDeviceTypeKeyAsync(DeviceRepository repo, string deviceTypeId, ListRequest listRequest);
