...
namespace LagoVista.IoT.DeviceManagement.Core.Models
{
    ...
    public class DeviceRepository : LagoVista.IoT.DeviceAdmin.Models.IoTModelBase, IValidateable, IEntityHeaderEntity, IFormDescriptor, IFormDescriptorAdvanced, IFormConditionalFields, IIconEntity, IFormDescriptorAdvancedCol2, ISummaryFactory
    {
        ...
        [FormField(LabelResource: DeviceManagementResources.Names.DeviceRepository_DefaultDeviceModel, WaterMark:DeviceManagementResources.Names.DeviceRepository_DefaultDeviceModel_Select, EntityHeaderPickerUrl: "/api/devicetypes", FieldType: FieldTypes.EntityHeaderPicker, ResourceType: typeof(DeviceManagementResources))]
        public EntityHeader DefaultDeviceModel { get; set; }
        ...
        [FormField(LabelResource: DeviceManagementResources.Names.DeviceRepository_DefaultTextingDevice, FieldType: FieldTypes.DevicePicker,
              WaterMark: DeviceManagementResources.Names.DeviceRepository_DefaultTextingDevice_Select,  HelpResource: DeviceManagementResources.Names.DeviceRepository_DefaultTextingDevice_Help,  
        ...
        public List<string> GetAdvancedFieldsCol2()
        {
            return new List<string>()
            {
                ...
                nameof(AutoIncrementDeviceIdMask),
                nameof(DeviceCapacity),
                nameof(StorageCapacity),
                nameof(DistroList),
                nameof(AssignedUser),
