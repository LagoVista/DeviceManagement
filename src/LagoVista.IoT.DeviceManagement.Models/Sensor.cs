...
namespace LagoVista.IoT.DeviceManagement.Models
{
    ...
    public class Sensor
    {
        ...
        [FormField(LabelResource: DeviceManagementResources.Names.Sensor_AttributeType, FieldType: FieldTypes.Picker, EnumType:typeof(ParameterTypes), ResourceType: typeof(DeviceManagementResources), IsRequired: false, WaterMark:DeviceManagementResources.Names.Sensor_AttributeType_Select)]
